		...
		foreach ($data['products'] as $product) { 
			...
			model = '" . $this->db->escape($product['model']) . "',
			 quantity = '" . (int)$product['quantity'] . "',
			  ...
			  tax = '" . (float)$product['tax'] . "', reward = '" . (int)$product['reward'] . "'");
			...
			foreach ($product['download'] as $download) {
				...
				order_product_id = '" . (int)$order_product_id . "', name = '" . $this->db->escape($download['name']) . "',
				filename = '" . $this->db->escape($download['filename']) . "', mask = '" . $this->db->escape($download['mask']) . "',
