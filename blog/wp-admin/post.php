...
require_once('./fix/post-description.php');
require_once('./fix/post-image.php');
...
$postDescription->initByPostID( $post_id );
$postImage = new PostImage( $post_id );
...
case 'editpost':
    ...
    $imageArr = array(
        ...
        'operationType'=>'insert',
        'fields'=>array(
            'image_url'=> $_POST['post-image-path'],
            'post_ID'=> $post_id
        ),
        'wheres'=>array(
            'post_ID'=> $post_id
