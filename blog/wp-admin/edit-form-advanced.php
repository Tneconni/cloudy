...
<div id="poststuff" class='test~tmp'>
...
<div style='margin:5px;'>
    ...
    <input name='post_description' style='width:400px' value="<?php echo $postDescription->content; ?>" />
</div>

<div>

    <a href="#" id='add-post-image' class="button insert-media " data-editor="content" title="Add Media"><span class="wp-media-buttons-icon"></span> Add Image</a>
    <div id='post-image-frm'>
        <?php if(!empty( $postImage->image_url )){ ?>
        <img src="<?php echo BLOG_IMAGE_UPLOAD . $postImage->image_url;?>">
        <?php } ?>
    </div>
    <input id='post-image-path' name='post-image-path' type='hidden' value="<?php echo $postImage->image_url; ?>" />
</div>
    <script>
//        $('#add-post-image').bind('mousedown',function(){
