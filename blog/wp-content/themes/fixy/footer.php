...
?>
		...
		<span class="external-ok" endis="<?php echo esc_attr(get_theme_mod('fixy_external_links_show')); ?>"></span>
		<span class="lazy-ok" endis="<?php echo esc_attr(get_theme_mod('fixy_lazy_content')); ?>"></span>
