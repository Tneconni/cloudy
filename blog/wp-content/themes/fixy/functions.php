...
function fixy_widgets_init() {
	...
	register_sidebar( array(
		...
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title" id="widget-title">',
		'after_title'   => '</h3>',
	) );
	...
	register_sidebar( array(
		...
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="footer-widget-title" id="footer-widget-title">',
		'after_title'   => '</h3>',
	) );
...
wp_enqueue_script('fit-video',get_template_directory_uri().'/js/FitVids/jquery.fitvids.js',array('jquery','scrolltofixed'));
...
//--------search field--------------------		
	...
	$field_option='<li><ul>';
			...
			$field_option .='<li class="search-field"><input type="text" value="' . get_search_query() . '" name="s" id="s"  placeholder="'.__('Search','fixy').'" /></li>
		</ul>
	</li>';
	endif;
...
//--------search button--------------------		
	if($default['button_show']==1):
		$button_option='<li>
							<input type="submit" id="searchsubmit" class="search-submit" value="'. esc_attr__( 'Search','fixy' ) .'" />
					   </li>';
	endif;
//--------links--------------------			
	if($default['advance_show']==1):
		$advance_option='<li><a id="advancesearch" href="">'.__('advance search','fixy').'</a></li>';
	endif;
	
	if($default['close_show']==1):
		$close_option='<li><a id="advancesearch-cancel">'.__('cancel','fixy').'<i class="icon-cancel"></i></a></li>';
	endif;
//--------final form-------------------		
		$form = '<form role="search" method="get" id="searchform" action="' . home_url( '/' ) . '" ><ul>
